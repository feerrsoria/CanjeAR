    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.card}>
                ...
                <p>Completa los detalles del producto que deseas ofrecer.</p>
                <label>Nombre</label>
                ...
                <input type="text" placeholder="Ubicación del producto" />
                <button>Agregar Producto</button>
            </div>

            {/* Decorative Image on the right */}
            <div className={styles.imageWrapper}>
              <Image src="/IMG-20250728-WA0003.jpg" alt="Cartera vintage" width={450} height={600}/>
            </div>
        </div>
    );
}